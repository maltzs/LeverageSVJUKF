function [L, z_hat] = particle_filter(y, T, N, theta, sigma_eta_hat, prime)
% PARTICLE_FILTER Runs one iteration of leverage stochastic-volatility
% particle filter.
%   Inputs:
...
%   particle filter.
%   - prime: Logical value whether phi is transformed to phi prime already
%   or not.
%
%   Ouputs:
...
%   of Science and Art (2022).
    ...
    for t = 2:T
        ...
        h_particles_hat1 = [h_particles_hat(1) h_particles_hat ...
            h_particles_hat(N)];
        h_particles = (h_particles_hat1(r+2)-h_particles_hat1(r+1)).* ...
