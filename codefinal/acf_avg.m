...
% ACF_AVG Averages and plots the absolute value sample autocorrelations of
% the simulations.
%   Inputs:
%   - T: Time span of run.
%   - stats: A statistics structure from statistics_tests. Must contain the
%   following field:
%       - acf: A struct with sample autocorrelations. Must contain the
%       following fields:
%           - z: Sample autocorrelation of the residual series.
%           - zsquared: Sample autocorrelation of the residual series
%           squared.
%
